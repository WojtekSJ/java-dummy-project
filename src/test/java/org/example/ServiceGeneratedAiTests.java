...
public class ServiceGeneratedAiTests {
    ...
    void testHighComplexityMethod_GivenAllPositive() {
        ...
        // THEN all three values should be printed as positive
    }

    @Test
    void testHighComplexityMethod_GivenAPositiveAndOthersNonPositive() {
        ...
        // WHEN highComplexityMethod is called with the inputs
        service.highComplexityMethod(a, b, c);
        // THEN "a is positive" and "b is non-positive" should be printed
    }
}
